...
recSp = LTBM3D_iter(I,recBM,sigma,opts);
...
set(gca,'fontsize',16,'Xtick',[],'Ytick',[]);
f4 = nexttile;imagesc(recBM4,[0 1]);title({'averaging LTBM3D';sprintf('PSNR = %g',psnr4)});
set(gca,'fontsize',16,'Xtick',[],'Ytick',[]);
...
set(gca,'fontsize',16,'Xtick',[],'Ytick',[]);
f7 = nexttile;imagesc(recSp,[0 1]);title({'BM3D combo';sprintf('PSNR = %g',myPSNR(IO,recSp,1))});
set(gca,'fontsize',16,'Xtick',[],'Ytick',[]);
linkaxes([f1 f2 f3 f4 f5 f6 f7]);