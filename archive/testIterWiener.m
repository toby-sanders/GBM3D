...
% testing an iterative approach to the Wiener filtering, by reapplying it
% multiple times after each estimate. The solution actually gets worse with
% each iteration
[U2,out] = LTBM3D_iter(I,sigma,opts);
